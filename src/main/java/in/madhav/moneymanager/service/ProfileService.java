...
import in.madhav.moneymanager.dto.AuthDTO;
import in.madhav.moneymanager.dto.ProfileDTO;
import in.madhav.moneymanager.entity.ProfileEntity;
import in.madhav.moneymanager.repository.ProfileRepository;
...
public class ProfileService {
        ...
        public boolean isAccountActive(String email) {
                ...
                return profileRepository
                                .findByEmail(email)
                                .map(profile -> Boolean.TRUE.equals(
                                                profile.getIsActive()))
                                .orElse(false);
        }
        ...
        public Map<String, Object> authenticateAndGenerateToken(
                        AuthDTO authDTO) {
